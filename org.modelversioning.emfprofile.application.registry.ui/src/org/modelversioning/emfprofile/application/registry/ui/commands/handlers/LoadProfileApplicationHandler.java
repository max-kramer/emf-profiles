...
public class LoadProfileApplicationHandler extends AbstractHandler implements
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		IEditorPart activeEditor = HandlerUtil.getActiveWorkbenchWindow(event)
			...
			MessageDialog
					.openError(
							HandlerUtil.getActiveWorkbenchWindow(event)
									.getShell(),
							"No model resource is opened!",
							"Before you can load profile application you have to open a model resource in an editor.");
		} else {
