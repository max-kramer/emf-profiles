 ...
 * <ul>
 *   <li>{@link org.modelversioning.emfprofile.decoration.decorationLanguage.impl.ActivationImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivationImpl extends MinimalEObjectImpl.Container implements Activation
{
  ...
  {
    return DecorationLanguagePackage.Literals.ACTIVATION;
  }
  ...
  public NotificationChain basicSetCondition(AbstractCondition newCondition, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DecorationLanguagePackage.ACTIVATION__CONDITION, oldCondition, newCondition);
  ...
  public void setCondition(AbstractCondition newCondition)
  {
    if (newCondition != condition)
    {
      ...
      if (condition != null)
        msgs = ((InternalEObject)condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DecorationLanguagePackage.ACTIVATION__CONDITION, null, msgs);
      if (newCondition != null)
        msgs = ((InternalEObject)newCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DecorationLanguagePackage.ACTIVATION__CONDITION, null, msgs);
      msgs = basicSetCondition(newCondition, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DecorationLanguagePackage.ACTIVATION__CONDITION, newCondition, newCondition));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DecorationLanguagePackage.ACTIVATION__CONDITION:
