...
import org.modelversioning.xtext.emfprofile.EMFProfileRuntimeModule;
...
public class Activator extends AbstractUIPlugin {
	...
	private void initializeEcoreInjector() {
		injector = Guice.createInjector(
				Modules.override(Modules.override(new EMFProfileRuntimeModule())
				.with(new EMFProfileUiModule(plugin)))
